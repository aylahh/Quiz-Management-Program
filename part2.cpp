...
void quiz_clang(){
	    ...
	    for(int i=0;i<3;i++){
	    cout<<"------------------------------------------------------------------------------------------------------=--------------------------"<<endl;
	    cout<<"--------------------------------------------- QUIZ FOR PARTICIPANT "<<i+1<<"-----------------------------------------------------"<<endl;
	    cout<<"---------------------------------------------------------------------------------------------------------------------------------"<<endl;
        cout<<"\n\t                  QUESTION#1                    \t\n"<<endl;
	...
	for(int i=0;i<5;i++) 
	{
        cout<<"\n                                                   \n"<<endl;
        result[i]=result[i]+1;
        cout<<"\t\tYOU GOT  "<< result[i]<<" MARKS IN C++ QUIZ OUT OF 5!\t\t"<<endl;
        incorrectAns[i]=5-result[i];
        cout<<"\t\tYOU ANSWERED "<<incorrectAns[i]<<" INCORRECT QUESTIONS!!\t\t"<<endl;
        cout<<"\n                                                   \n"<<endl;
     }
...
int main(){
	  char desire;
      cout<<"\t(:)(:)(:)(:)(:)(:)(:)(:)----    ONLINE QUIZ SYSTEM FOR EVERYONE!!    ------(:)(:)(:)(:)(:)(:)(:)(:)(:)(:)\t"<<endl;
      cout<<"          ----------  THIS QUIZ WILL HELP YOU TO KNOW YOUR CAPABILITIES AND BROADEN YOUR VISION !!!   --------"<<endl;
      cout<<"          ----------  THIS IS A QUIZ BETWEEN 3 PEOPLE AND ONE WINNER WILL BE CHOOSED AT THE END !!!   --------"<<endl;
     
       participantInfo p1[3];
        for (int i=0;i<3;i++)
		{ 
		 cout<<"\n                          \n"<<endl;
	     cout<<"\t\tDETAILS OF "<<i<<" PARTICIPANT ARE: \t\t"<<endl;
	     ...
	     cin>>p1[i].qualification;
	     getline(cin,p1[i].qualification);
	     cout<<"ENTER YOUR COUNTRY AND CITY: "<<endl;
	     cin>>p1[i].location;
	     getline(cin,p1[i].location);
	   
      }

  do{
    char quiz_cases;
     cout<<"\t\tPRESS 1 TO PLAY C++ QUIZ!:))))\t\t"<<endl;
  ...
  cout<<"DO YOU AGAIN WANT TO PLAY THE QUIZ??PRESS Y/y and N/n according to your desire!!"<<endl;
  cin>>desire;
  system("cls");
}while(desire=='Y'||desire=='y');
   
  cout<<"\t\tTHANKYOU FOR PARTICIPATING!!HOPE YOU ENJOYED!!COME BACK AGAIN:)))))\t\t"<<endl;
